        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <ScrollReveal>
            <div className="mt-10 mb-6">
              <div className="relative aspect-[3/4] max-w-[24rem] mx-auto overflow-hidden">
                <Image
              ...
              {[
                {
                  ...
                  title: "The Beginning",
                  desc: "Glen Ellyn Park District. Two seasons. First season: zero goals until the final game, then scored twice. Second season: scored constantly, forcing an early move to Lakers Academy. Named 'Most Improved Player' by Coach James Reiman, who still comes to Theo's travel games years later.",
                },
                {
                ...
                },
                {
                  ...
                  desc: "6 goals and counting. Building momentum at the highest club level. The pattern repeats.",
                },
              ].map((item) => (
                <div
                  key={item.period}
